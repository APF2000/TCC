...
A análise de dados no contexto deste projeto pode ser eficientemente conduzida utilizando o Jupyter Notebook, uma poderosa ferramenta interativa para análise de dados e programação em Python. Ao importar os conjuntos de informações coletadas pelo sistema para o Jupyter Notebook, é possível explorar, visualizar e interpretar os dados de maneira flexível. 
...
% (\textit{Driver behaviour profiling using smartphone sensory data in a V2I environment}\textsuperscript{[15]})
