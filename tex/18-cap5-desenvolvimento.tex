...
\end{figure}
     ...
     \item{tcc_schema}
     \item{info} Armazena as informações coletadas através da porta OBD

     \item{acceleration} Contém dados dos acelerômetros do celular do usuário
     
     \item{location} Guarda latitude e longitude obtidas por GPS pelo celular
